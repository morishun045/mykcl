                ...
                <div className={styles.floorall}>
                    <div className={styles.floorleft}>
                        <div className={styles.floorContent}>
                            <RoomName roomname="1401講義室" grade="" detail="" />
                        </div>
                        <div className={styles.floorContent}>
                            <RoomName roomname="1402講義室" grade="" detail="" />
                        </div>
                        <div className={styles.floorContent}>
                            <Stair />
                        </div>
                        <div className={styles.floorContent}>
                            <RoomName roomname="1403講義室" grade="" detail="" />
                        </div>
                    </div>
                    <div className={styles.floorContent}>
                            <Eleveter />
                    ...
                    <div className={styles.floorright}>
                        <div className={styles.floorContent}>
                            <RoomName roomname="1404講義室" grade="" detail="" />
                        </div>
                        <div className={styles.floorContent}>
                            <Stair />
                        </div>
                        <div className={styles.floorContent}>
                            <RoomName roomname="1405講義室" grade="" detail="" />
                        </div>
                    </div>
                </div>
            </div>
